                        ...
                        <div class="card p-3 shadow-lg my-5">
                            <div class="row">
                                ...
                                <div class="class-group col-12 col-md-6">
                                    ...
                                    <input type="number" id="n_beds" name="n_beds" class="form-control @error('n_beds')is-invalid @enderror" placeholder="Inserisci posti letto" value="{{ old('n_beds') }}" required>
                                    @error('n_beds')
                                        <div class="text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
                                <div class="class-group col-12 col-md-6">
                                    ...
                                    <input type="number" id="n_bathrooms" name="n_bathrooms" class="form-control @error('n_bathrooms')is-invalid @enderror" placeholder="Inserisci il numero dei bagni" value="{{ old('n_bathrooms') }}" required>
                                    @error('n_bathrooms')
                                        <div class="text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
                                <div class="class-group col-12 col-md-6">
                                    ...
                                    <input type="number" id="mq" name="mq" class="form-control @error('mq')is-invalid @enderror" placeholder="Inserire i mq" value="{{ old('mq') }}" required>
                                    @error('mq')
                                        <div class="text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
                                <div class="class-group col-12 col-md-6">
                                    ...
                                    <input type="text" id="address" name="address" class="form-control @error('address')is-invalid @enderror" placeholder="Inserisci l'indirizzo" value="{{ old('address') }}" required>
                                    @error('address')
                                        <div class="text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
